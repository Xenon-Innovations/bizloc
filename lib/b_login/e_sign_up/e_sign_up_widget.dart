...
import 'e_sign_up_model.dart';
export 'e_sign_up_model.dart';

class ESignUpWidget extends StatefulWidget {
  const ESignUpWidget({super.key});

  static String routeName = 'e_signUp';
  static String routePath = '/eSignUp';

  @override
  State<ESignUpWidget> createState() => _ESignUpWidgetState();
}

class _ESignUpWidgetState extends State<ESignUpWidget> {
  late ESignUpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ESignUpModel());
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        ...
                        await MailRecord.collection.doc().set({
                          ...
                          ...mapToFirestore(
                            {
                              'to': [_model.emailTextFieldTextController.text],
                            },
                          ),
                        });

                        context.pushNamed(
                          CCodeSignUpWidget.routeName,
                          queryParameters: {
