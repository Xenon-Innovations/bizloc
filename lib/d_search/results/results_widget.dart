...
import '/components/payment_comp/payment_comp_widget.dart';
...
class _ResultsWidgetState extends State<ResultsWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ReportsRecord>(
      stream: ReportsRecord.getDocument(widget!.report!),
      builder: (context, snapshot) {
        ...
        final resultsReportsRecord = snapshot.data!;
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    ...
                                    text: resultsReportsRecord.saved
                                        ? 'Delete location'
                                        : 'Save location',
                                    icon: Icon(
                                      FFIcons.kbookmark2,
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    16.0, 0.0, 16.0, 0.0),
                                            child: AutoSizeText(
                                              resultsReportsRecord.adressStr,
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        '${resultsReportsRecord.demographicScore.toString()}/100',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.manrope(
                                              ...
                                              color: () {
                                                if (resultsReportsRecord
                                                        .demographicScore <
                                                    25) {
                                                  return FlutterFlowTheme.of(
                                                          context)
                                                      .error;
                                                } else if (resultsReportsRecord
                                                        .demographicScore <
                                                    50) {
                                                  return FlutterFlowTheme.of(
                                                          context)
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Align(
                                        ...
                                        child: Text(
                                          resultsReportsRecord.population
                                              .toString(),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                    ...
                                    children: [
                                      ...
                                      Align(
                                        alignment:
                                            AlignmentDirectional(-1.0, 0.0),
                                        child: Text(
                                          resultsReportsRecord.medianAge,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                font: GoogleFonts.manrope(
                          ...
                          child: Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                while (currentUserDocument?.timeTryingToBuy ==
                                    null) {
                                  await Future.delayed(
                                      const Duration(milliseconds: 100));
                                }
                                if (functions.isMonthPassed(
                                    currentUserDocument!.createdTime!,
                                    currentUserDocument!.timeTryingToBuy!)) {
                                        ...
                                        child: GestureDetector(
                                          ...
                                          child: Padding(
                                            padding: MediaQuery.viewInsetsOf(
                                                context),
                                            child: PaymentCompWidget(
                                              reportReference: widget!.report!,
                                            ),
                                          ),
                                        ),
                                      );
