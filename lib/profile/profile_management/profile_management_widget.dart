...
import 'profile_management_model.dart';
export 'profile_management_model.dart';

class ProfileManagementWidget extends StatefulWidget {
  const ProfileManagementWidget({super.key});

  static String routeName = 'ProfileManagement';
  static String routePath = '/profileManagement';
...
class _ProfileManagementWidgetState extends State<ProfileManagementWidget> {
  late ProfileManagementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileManagementModel());
                ...
                FFButtonWidget(
                  onPressed: () async {
                    ...
                    if (_model.textController2.text != currentUserEmail) {
                      ...
                      await actions.updateEmailWithoutVerification(
