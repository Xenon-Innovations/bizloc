                          ...
                          builder: (alertDialogContext) {
                            return WebViewAware(
                              child: AlertDialog(
                                ...
                                content: Text(
                                    'Password reset link was successfully send to your email address'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
                ...
                Builder(
                  builder: (context) => FFButtonWidget(
                    onPressed: () async {
                            ...
                            return Dialog(
                              ...
                              child: WebViewAware(
                                child: GestureDetector(
                                  ...
                                  child: AlertDialogWidget(
                                    title: 'New pussword password unset',
                                    subtitle: 'Please, input your new password',
                                  ),
                                ),
                              ),
                            );
                      ...
                      if (_model.confirmPasswordTextFieldTextController.text ==
                              null ||
                              ...
                              child: WebViewAware(
                                child: GestureDetector(
                                  ...
                                  child: AlertDialogWidget(
                                    title: 'Confirm new password',
                                    subtitle:
                                        'Your new password doesn\'t match confirmed password',
                                  ),
                                ),
                              ),
                            );
                      ...
                      _model.currentPasswordConfirmed =
                          await actions.checkCurrentPassword(
                        _model.currentPasswordTextFieldTextController.text,
                      );
                      _shouldSetState = true;
                      if (!_model.currentPasswordConfirmed!) {
                        await showDialog(
                          context: context,
                          builder: (dialogContext) {
                            return Dialog(
                              ...
                              child: WebViewAware(
                                child: GestureDetector(
                                  ...
                                  child: AlertDialogWidget(
                                    ...
                                    subtitle:
                                        'Please, input current password again',
                                  ),
                                ),
                              ),
                            );
                            ...
                            child: WebViewAware(
                              child: GestureDetector(
                                ...
                                child: AlertDialogWidget(
                                  title: 'Success!',
                                  subtitle:
                                      'Your password was changed sucessfully',
                                ),
                              ),
                            ),
                          );
